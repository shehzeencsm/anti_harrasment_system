                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Report to Anti Harassment department</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-md-4 mt-3  ">
                                        <input type="submit" class="btn btn-warning" name="edit_report" value="Update Report" name="">
                                    </div>
                                </div>
                            </form>
                        </div>
